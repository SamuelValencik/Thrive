...
public class MicrobeResistanceStub : Microbe
{
    public MicrobeResistanceStub(float resistance)
    {
        Node world = new Node();
        world.AddChild(this);
        ...
        membraneType.ToxinResistance = resistance;
        membraneType.PhysicalResistance = resistance;
